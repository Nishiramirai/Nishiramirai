...
### 📚 Favorite Books
- **`C`** Head First C by David Griffiths, Dawn Griffiths
- **`C`** C Primer Plus by Stephen Prata
- **`C++`** Object-Oriented Programming in C++ by Robert Lafore
- **`Algorithms`** A Common-Sense Guide to Data Structures and Algorithms by Jay Wengrow
- **`Computer Science`** How Computers Really Work by Matthew Justice
- **`Low-Level`** Code: The Hidden Language by Charles Petzold    
